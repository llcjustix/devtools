...
var interfaceConfig = {
    // LearnX Branding
    APP_NAME: 'LearnX',
    PROVIDER_NAME: 'LearnX',

    // Note: All colors are controlled via custom-styles.css
    // These legacy settings remain for Jitsi internal use only
    ...
    DEFAULT_BACKGROUND: '#000000', // Black background
    DEFAULT_WELCOME_PAGE_LOGO_URL: 'images/learnx-logo.svg',
